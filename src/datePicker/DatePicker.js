...
DatePicker.propTypes = {
  ...
  minimumDate: PropTypes.oneOf([PropTypes.string, PropTypes.number]),
  maximumDate: PropTypes.oneOf([PropTypes.string, PropTypes.number]),
  minimumTime:  PropTypes.oneOf([PropTypes.string, PropTypes.number]),
  maximumTime:  PropTypes.oneOf([PropTypes.string, PropTypes.number]),
